 ...
 * Professional template with emerald green accents
 */
...
interface EmeraldPDFProps {
  resume: Resume;
}

export const EmeraldPDF = ({ resume }: EmeraldPDFProps) => {
            ...
            <View style={styles.mainSection}>
              ...
              {resume.projects.map((project, index) => (
                <View key={index} style={styles.projectItem}>
                  ...
                  {project.url && (
                    <Link src={project.url} style={[styles.sidebarLink, { color: '#047857' }]}>
                      View Project
                    </Link>
                  )}
                </View>
